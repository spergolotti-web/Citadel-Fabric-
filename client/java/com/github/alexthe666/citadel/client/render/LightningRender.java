...
public class LightningRender {
    ...
    public void render(float partialTicks, PoseStack PoseStackIn, SubmitNodeCollector collector) {
        ...
        for (Iterator<Map.Entry<Object, BoltOwnerData>> iter = boltOwners.entrySet().iterator(); iter.hasNext(); ) {
            ...
            collector.submitCustomGeometry(PoseStackIn, RenderTypes.lightning(), (pose, buffer) -> {
