...
public abstract class CitadelPatreonRenderer {
    ...
    public abstract void render(PoseStack matrixStackIn, SubmitNodeCollector collector, int light, float partialTick, LivingEntity entity, float distanceIn, float rotateSpeed, float rotateHeight);
