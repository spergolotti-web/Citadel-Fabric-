...
public class GuiCitadelPatreonConfig extends OptionsSubScreen {
    ...
    protected void init() {
        ...
        int i = this.width / 2;
        int j = this.height / 6;
        Button doneButton = Button.builder(CommonComponents.GUI_DONE, (p_213079_1_) -> this.minecraft.setScreenAndShow(this.lastScreen)).size(200, 20).pos(i - 100, j + 120).build();
