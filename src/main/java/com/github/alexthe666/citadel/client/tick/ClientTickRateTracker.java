...
import com.github.alexthe666.citadel.mixin.client.TimerAccessor;
...
public class ClientTickRateTracker extends TickRateTracker {
    ...
    public void masterTick() {
        super.masterTick();
        DeltaTracker.Timer timer = ((MinecraftAccessor) client).citadel$getTimer();
        ((TimerAccessor) timer).citadel$setMsPerTick(getClientTickRate());
    }
