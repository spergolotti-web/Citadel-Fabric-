        ...
        for (BasicModelPart.ModelBox BasicModelPart$modelbox : this.cubeList) {
            for (BasicModelPart.TexturedQuad BasicModelPart$texturedquad : BasicModelPart$modelbox.quads) {
                ...
                for (int i = 0; i < 4; ++i) {
                    ...
                    bufferIn.addVertex(vector4f.x(), vector4f.y(), vector4f.z(), colorARGB, BasicModelPart$positiontexturevertex.textureU, BasicModelPart$positiontexturevertex.textureV, packedOverlayIn, packedLightIn, f, f1, f2);
                }
            }
        }
