...
public class MessageSyncPathReached {
    ...
    public static class Handler {
        ...
        public static boolean handle(MessageSyncPathReached message, Supplier<PacketContext> contextSupplier) {
            contextSupplier.get().enqueueWork(() -> {
                contextSupplier.get().setPacketHandled(true);

                if (contextSupplier.get().getDirection() == PacketContext.PacketDirection.PLAY_TO_CLIENT) {
