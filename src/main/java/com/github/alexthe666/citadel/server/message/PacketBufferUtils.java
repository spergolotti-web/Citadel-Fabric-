...
public class PacketBufferUtils {
     ...
     * @param registryAccess Registry access for serialization
     */
    public static void writeItemStack(ByteBuf to, ItemStack stack, RegistryAccess registryAccess) {
        RegistryFriendlyByteBuf pb = new RegistryFriendlyByteBuf(to, registryAccess);
        ItemStack.STREAM_CODEC.encode(pb, stack);
    }
     ...
     */
    public static ItemStack readItemStack(ByteBuf from, RegistryAccess registryAccess) {
        RegistryFriendlyByteBuf pb = new RegistryFriendlyByteBuf(from, registryAccess);
        try {
            return ItemStack.STREAM_CODEC.decode(pb);
        } catch (Exception e) {
