...
public enum AnimationHandler {
    ...
    public <T extends Entity & IAnimatedEntity> void sendAnimationMessage(T entity, Animation animation) {
        ...
        AnimationMessage.sendToAllPlayers(
                new AnimationMessage(entity.getId(), ArrayUtils.indexOf(entity.getAnimations(), animation)),
                entity.level().getServer().getPlayerList().getPlayers());
    }
        ...
        if (entity.getAnimation() == null) {
            ...
            if (entity.getAnimation() != IAnimatedEntity.NO_ANIMATION) {
                ...
                if (entity.getAnimationTick() < entity.getAnimation().getDuration()) {
                    ...
                    new AnimationEvent.Tick<>(entity, entity.getAnimation(), entity.getAnimationTick()).post();
                }
                if (entity.getAnimationTick() == entity.getAnimation().getDuration()) {
